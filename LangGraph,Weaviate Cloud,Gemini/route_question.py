...
class RouteQuery(BaseModel):
    ...
    datasource: Literal["Uniinfo","NoxVision","English","Gemini"] = Field(
        ...,
...
def route_quest(state):
    ...
    Use the vectorstores for their related questions. Otherwise, use Gemini"""
